...
const CartItem = ({onContinueShopping, onRemoveCart}) => {
  ...
  const calculateTotalAmount = () => {
    let total = 0;
    cart.map((item) => (total = total + calculateTotalCost(item)));
    return total;
  };
  ...
  const handleCheckoutShopping = (e) => {
    alert(`The Order for $${calculateTotalAmount()} has been placed`);
  };
